...
MODEL              = vehicle_mode1
MODULES            = rtGetInf.c rtGetNaN.c rt_look.c rt_look2d_normal.c vehicle_mode1_sf_data.c 
MAKEFILE           = vehicle_mode1.mk
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=vehicle_mode1lib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\vehicle_mode1_sfcn_rtw
